  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-shopping-cart"></i> <?php echo $text_order_detail; ?></h6>
          </div>
          <table class="table">
            <tbody>
              <tr>
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-user"></i> <?php echo $text_customer_detail; ?></h6>
          </div>
          <table class="table">
            <tr>
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-cog"></i> <?php echo $text_option; ?></h6>
          </div>
          <table class="table">
            <tbody>
              <tr>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-info-circle"></i> <?php echo $text_order; ?></h6>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-comment-o"></i> <?php echo $text_history; ?></h6>
      </div>
      <div class="panel-body">
