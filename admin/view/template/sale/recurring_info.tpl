  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_recurring_detail; ?></h6>
          </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_order_detail; ?></h6>
          </div>
          <div class="panel-body">
            <table class="table table-bordered">
              <tr>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_product_detail; ?></h6>
      </div>
      <div class="panel-body">
        <table class="table table-bordered">
          <thead>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_transaction; ?></h6>
      </div>
