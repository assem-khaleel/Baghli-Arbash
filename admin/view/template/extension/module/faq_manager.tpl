								...
								<div class="tab-content">
									...
									<div class="form-group required">
										...
										<div id="groups-<?php echo $section_row; ?>">
											<div class="panel panel-default">
												<div class="panel-heading"><h6 class="panel-title"><?php echo $entry_section_question_answer; ?></h6></div>
...
<script type="text/javascript">
	...
	function addSection() {
		...
		html += '				<div class="panel-heading"><h6 class="panel-title"><?php echo $entry_section_question_answer; ?></h6></div>';
