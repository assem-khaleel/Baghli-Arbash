      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          ...
          <div class="tab-pane">
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label" for="input-terms-services"><?php echo $entry_terms; ?></label>
            <div class="col-sm-10">
                <input type="checkbox" name="terms_service" <?php if($terms_service==1) echo 'checked="checked"';?> id="terms_service" value="1" />
              
            </div>
          </div>   
            <div id="div_for_products" class="form-group" <?php if($terms_service!=1) { echo 'style="display:none"';}?>>
            <label class="col-sm-2 control-label" for="input-products"><?php echo $entry_products; ?></label>
            <div class="col-sm-10">
                <input type="checkbox" name="products" <?php if($terms_service==1) echo 'checked="checked"';?> id="products" value="1" />
