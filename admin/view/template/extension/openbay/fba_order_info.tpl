        ...
        <div class="tab-pane active" id="tab-general">
          <div class="row">
            <div class="col-md-6">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h6 class="panel-title"><i class="fa fa-shopping-cart"></i> <?php echo $text_shipping_address; ?></h6>
                </div>
                <table class="table">
                  <tbody>
                  <tr>
            ...
            <div class="col-md-6">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h6 class="panel-title"><i class="fa fa-user"></i> <?php echo $text_order_info; ?></h6>
                </div>
                <table class="table">
                  <tr>
