  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_summary; ?></h6>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="panel panel-default dsr-table">
              <div class="panel-heading">
                <h6 class="panel-title"><i class="fa fa-bar-chart-o fa-lg"></i> <?php echo $text_report_30; ?></h6>
              </div>
              <div class="panel-body">
          ...
          <div class="col-md-6">
            <div class="panel panel-default dsr-table">
              <div class="panel-heading">
                <h6 class="panel-title"><i class="fa fa-bar-chart-o fa-lg"></i> <?php echo $text_report_52; ?></h6>
              </div>
              <div class="panel-body">
