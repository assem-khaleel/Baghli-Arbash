...
<div id="content">
 ...
 <td>
                ...
                <div class="input-group date" id="datetimepicker1">
                    <input type="text" class="form-control" name="banner_module[<?php echo $banner_module['key']; ?>][startdate]" placeholder="Start Date"/>
				...
				<div class='input-group date' id='datetimepicker2'>
                    <input type='text' class="form-control" name='banner_module[<?php echo $banner_module['key']; ?>][enddate]' placeholder='End Date'/>
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
...
function addImage() {
	...
	html += '  <td class="text-left"><div class="input-group date" id="datetimepicker1['+image_row+']"><input type="text" class="form-control" name="banner_module['+image_row+'][startdate]" placeholder="Start Date"/><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div>';
	html += '  <div class="input-group date" id="datetimepicker2['+image_row+']"><input type="text" class="form-control" name="banner_module['+image_row+'][enddate]" placeholder="End Date"/><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div></td>';
