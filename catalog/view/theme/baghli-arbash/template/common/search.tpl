<div id="search" class="col-md-7" style="padding-left:21px ">
                        <div  class="input-group stylish-input-group srch_updte">
							<select name="search_type"  id="search_type" class="sub_selct"> <option value="category"><?=$all ?></option>  <option value="category"><?=$Brands ?></option><option value="category"><?= $Category ?> </option> </select>
