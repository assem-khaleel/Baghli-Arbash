              ...
              <div class="col-md-6 proLst-cont updte_design">
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <span class="save"><a href="#">ADDED ON: <?= $product['date_added'];?></a> </span>
...
$(function(){
  ...
  $('.rateyo').rateYo({rating:'<?= (int)$product['rating']?>'});
                      ...
                      <div class="dicnt algnvww">View : <span><?=$product['viewed'] ?></span></div>
...
<span class="stock-out"><?php echo $product['stock']?></span>
                ...
                <div class="col-md-6" style="float: right; margin-top:-80px; margin-bottom: 5px;">
                   <div class="add-crt ">
            <input id="button-cart" onclick="cart.add('<?php echo $product['product_id'];?>')" value="ADD TO CART" class="btn_wrap add_algn" type="button">
          </div>
                     <div class="add-crt">
