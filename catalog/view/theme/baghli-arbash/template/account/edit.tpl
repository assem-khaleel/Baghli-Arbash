      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
         ...
         <div class="form-group required">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-mobile"><?php echo $entry_mobile1; ?></label>
            <div class="col-sm-10">
              <input type="tel" name="mobile" value="<?php echo $mobile; ?>" placeholder="<?php echo $entry_mobile1; ?>" id="input-mobile" class="form-control" />
              <?php if ($error_mobile) { ?>
