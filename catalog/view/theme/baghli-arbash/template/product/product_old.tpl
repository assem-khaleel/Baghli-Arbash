<?php echo $header; ?>
<div class="innr-banner"><img src="catalog/view/theme/baghli-arbash/images/innr-bnr-17.png" alt=""></div>
<div class="container">
  ...
  <div class="heading"><span><strong>Product </strong> Details</span></div>
	<div class="row prod-details clearfix">
            ...
            <div id="mac2" class="owl-carousel">
              <div class="item"><img src="images/prod-1.jpg" alt=""></div>
           ...
           <p>A small description about this product can be shown here. A small description about this item can be shown here.description about this product can be shown here.   </p>
				<?php if ($manufacturer) { ?>
				<span class="brannd_mame"><?php echo $text_manufacturer; ?> <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></span>
				<?php } ?>
               <div class="str-area">
               ...
               <table class="discription" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><div class="input-group spinner">
                            <input class="form-control" value="42" type="text">
                  ...
                  <tr>
                    <td>COLOR</td>
                    <td>:</td>
                    <td><div class="dropdown productDetail-color">
               ...
               <input name="" type="checkbox" value=""><label>Send me email when it is available </label>
                  ...
                  <tr >
                    <td colspan="3">
                        ...
                        <button type="button" onclick="wishlist.add('<?php echo $product_id; ?>');" class="btn btn-arw grey ">ADD TO WISH LIST <i><img src="catalog/view/theme/baghli-arbash/images/arrow.png" alt=""></i></button>
                        <button onClick="window.location.href='<?php echo $shopping_cart;?>'" type="button" class="btn btn-arw ">Check Out Now <i><img src="catalog/view/theme/baghli-arbash/images/arrow.png" alt=""></i></button>
                    </td>
                  </tr>
                </table>
