...
<?php  }?>
          <ul class="thumbnails">
            ...
            <img src="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" width="100%" height="390px" style="width: 100% !important;" />
            </a>
            </div>
            </div>
...
<?php foreach ($images as $image) { ?>
          ...
          <div class="easyzoom easyzoom--overlay">
            <a href="<?php echo $image['popup']; ?>">
              <img src="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" width="100%" height="390px" style="width: 100% !important;" />
            </a>
          </div>
          </div>
  <?php }?>
          ...
          <div class="share_box">
           <h5>Share Now :</h5>
             ...
             <li><a href="https://twitter.com/login" title="twitter"><img src="image/share_icon1.png" alt=""> </a></li>
                     ...
                     <li><a href="https://www.facebook.com/login" title="facebook"><img src="image/share_icon2.png" alt=""> </a></li>
            ...
            <?php if ($price) { ?>
                <?php if (!$special) { ?>
                  <tr class="price_nw">
                    ...
                    <td width="5%">:</td>
                    <td width="71%"><strong><?php echo $price; ?></strong></td>
                  </tr>
                <?php } else { ?>
                  <tr class="price_nw">
                    <td width="24%"><?=$price_now?> </td>
          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              <label class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
                          ...
                          <td width="71%">
                          <div class="dropdown productDetail-color">
                      ...
                      <ul class="dropdown-menu _select_color_drop" aria-labelledby="dropdownMenu1" id="input-option<?php echo $option['product_option_id']; ?>">
                      <?php foreach ($option['product_option_value'] as $option_value) { ?>
                        <li value="<?php echo $option_value['product_option_value_id']; ?>"><span _text_display="<?php echo $option_value['name']; ?>" class="color <?php echo strtolower($option_value['name']); ?>"></span></li>
                      <?php } ?>
...
<!--
            <?php if ($recurrings) { ?>
            <hr>
            <h6><?php echo $text_payment_recurring; ?></h6>
...
-->
              ...
              <div class="stock_clear">
                ...
                ?>
               <form>
               <input <?php if($logged){ echo 'name="notify-me"'; }else{ echo 'name="login-me"'; } ?> type="checkbox" value=""><label>Send me email when it is available </label>
               </form>
               <?php if($logged){ ?>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                      ...
                      <div class="modal-body">
                        We will send you notification once the item back to stock
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="x()">Ok</button>
                      </div>
                    </div>
                  </div>
                </div>
   ...
   <div class="vdeo-gal">
          ...
          <div class="row">
                ...
                <div id="video">
                  ...
                  <div class="item"><a  type="button" data-toggle="modal" data-target="#myModal1"><span class="vid"><img src="image/prod-1.jpg" alt=""></span></a></div>
                  <div class="item"><a  type="button" data-toggle="modal" data-target="#myModal1"><span class="vid"><img src="image/prod-1.jpg" alt=""></span></a></div>
                  <div class="item"><a  type="button" data-toggle="modal" data-target="#myModal1"><span class="vid"><img src="image/prod-1.jpg" alt=""></span></a></div>
                  <div class="item"><a  type="button" data-toggle="modal" data-target="#myModal1"><span class="vid"><img src="image/prod-1.jpg" alt=""></span></a></div>
                  <div class="item"><a  type="button" data-toggle="modal" data-target="#myModal1"><span class="vid"><img src="image/prod-1.jpg" alt=""></span></a></div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?= $Video_title ?></h4>
                      </div>
                      <div class="modal-body">
