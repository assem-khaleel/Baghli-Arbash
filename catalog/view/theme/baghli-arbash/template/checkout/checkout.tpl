<?php echo $header; ?>
 <div class="innr-banner"><img src="image/innr-bnr-02.png" alt=""></div>
<div class="container">
...
<form>
 ...
 -->       <!--  <div class="panel panel-default">
        ...
        <div class="panel panel-default">
          ...
          <div class=" " id="collapse-shipping-method">
            <div class="panel-body"></div>
          </div>
        </div>
        <?php } ?> -->
...
<div class="container inner-page">
      <div class="heading"><span><strong> <?=$re?></strong> </span></div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h6 class="modal-title" id="myModalLabel">Add New Address</h6>
                      </div>
                      <div class="modal-body clearfix">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                            <label>Address Name <span class="req">* </span></label>
                            <input placeholder="Address Name" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Area <span class="req">* </span></label>
                            <input placeholder="Area" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Governorate <span class="req">* </span></label>
                            <input placeholder="Governorate" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Block <span class="req">* </span></label>
                            <input placeholder="Block" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                            <label>Avenue </label>
                            <input placeholder="Avenue" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Building Number <span class="req">* </span></label>
                            <input placeholder="Building Number" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Floor Number <span class="req">* </span></label>
                            <input placeholder="Floor Number" class="form-control" type="text">
                            </div>
                            <div class="col-md-6">
                            <label>Flat Number <span class="req">* </span></label>
                            <input placeholder="Flat Number" class="form-control" type="text">
                            </div>
                            </div>
                         </form>
                      </div>
