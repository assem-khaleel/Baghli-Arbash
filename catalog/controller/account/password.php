...
//     elseif(($this->request->server['REQUEST_METHOD'] == 'POST') && $this->request->post['password-ajax'] == 'true' && $this->validate()) {
//
//
//
//            die('ajax');
...
//		}
      ...
      //  $data['entry_currentpassword'] = $this->language->get('entry_currentpassword');
