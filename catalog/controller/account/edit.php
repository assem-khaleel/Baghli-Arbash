...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->request->post['edit-ajax'] != 'true' && $this->validate()) {
		...
		//////////// * Edit form in account using AJAX * ///////////////
        ...
        $data['entry_mobile1'] = $this->language->get('entry_mobile1');
		...
		if (isset($this->error['lastname'])) {
         ...
         if (isset($this->error['fullname'])) {
			$data['error_fullname'] = $this->error['error_fullname'];
		} else {
			$data['error_fullname'] = '';
		}
