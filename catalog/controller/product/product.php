...
// $product_like= $this->model_catalog_product->like();
...
//echo '<pre>';print_r($option);exit;
                ...
                else if ((($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) && (float)$option_value['price']) {
